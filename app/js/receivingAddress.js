...
var personalDataMain = new Vue({
	...
	methods: {
		...
		editAddressBoxFn: function(val, id, name, region, addr, phone) {
		...
		delAddressBoxFn: function(val, who, id) { // 删除收货人信息
			this.delBox = val;
			if(who == '1') { // 确定删除
		...
		updateUserReceiveInfo: function() { // 收货地址的修改
			// 区域拼接
